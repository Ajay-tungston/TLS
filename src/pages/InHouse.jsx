  ...
  return (
    <>
      ...
      <section className="bg-black w-screen min-h-screen flex flex-col items-center justify-start pt-20 md:pt-32 lg:pt-40 px-4 md:px-8 lg:px-16">
        ...
        <div className=" mt-[52px] overflow-x-auto pb-10">
```jsx
// Improved code for the PlanCard component
const PlanCard = ({ name, specKey, isTopRated }) => {
  // Plan specifications based on specKey
  const specs = {
    Pulse2: { cpu: "1 vCPU", ram: "4 GB", storage: "50 GB" },
  ...
  return (
    <div className="relative flex flex-col h-full">
      ...
      >
        ...
        <div className="flex flex-col justify-start items-start gap-4">
          {/* CPU */}
          <FeatureItem boldPart={currentSpecs.cpu} restPart="core" />

          {/* RAM */}
          <FeatureItem boldPart={currentSpecs.ram} restPart="RAM" />

          {/* Storage */}
          <FeatureItem boldPart={currentSpecs.storage} restPart="NVMe SSD storage" />

          {/* Bandwidth */}
          <FeatureItem boldPart="Unlimited" restPart="bandwidth" />

          {/* Linux Support */}
          <FeatureItem
            boldPart=""
            restPart="Supports multiple Linux distributions"
          />
        </div>
      </div>
    </div>
...
// Improved code for the FeatureItem component
const FeatureItem = ({ boldPart, restPart }) => {
  return (
    <div className="inline-flex justify-start  gap-px">
      <div className="w-4 h-4 bg-zinc-300" />
      <div className="w-2 h-2 bg-[#ff7554]" />
      <div className="justify-start">
        {boldPart && (
